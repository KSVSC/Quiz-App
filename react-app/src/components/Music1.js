  ...
  return (
    ...
    <div className="App">
      <header className="App-header">
        <h1 className="App-title">Music-SingleCorrect</h1>
      </header>
            <center >
         {this.state.data.map((item, key)=>  {
               return (
                 <div>
               			{(item.genre==='Music' && item.q_type=='1') &&
                     <div>  
                      <h2>{item.question}</h2>
                      <h4><input
                        type="radio"
                    ...
                    <div>
                      {(!(this.state.data.genre==="Music" && this.state.data.q_type==="1")) &&
                      <div>
                        <center>
                        <h2> Score= {this.score}</h2>
                        <li><button onClick={this.musicOne}>Continue</button></li>
                        <br></br><h2>Finished the Music quiz1 <br></br></h2>
                        </center>
                      </div>
                      }
                      </div>
