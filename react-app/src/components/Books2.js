  ...
  return (
    ...
    <div className="App">
      <header className="App-header">
        <h1 className="App-title">Books-MultipleCorrect</h1>
      </header>
            <center >
         {this.state.data.map((item, key)=>  {
               return (
                 <div>
               			{(item.genre==='Books' && item.q_type=='2') &&
                     <div>  
                      <h2>{item.question}</h2>
                      <h4><input
                        type="radio"
                    ...
                    <div>
                      {(!(this.state.data.genre==="Books" && this.state.data.q_type==="2")) &&
                      <div>
                        <center>
                        <h2> Score= {this.score}</h2>
                        <li><button onClick={this.musicOne}>Continue</button></li>
                        <br></br><h2>Finished the Books quiz2 <br></br></h2>
                        </center>
                      </div>
                      }
                      </div>
